...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'aTen', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '匆匆过客', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.aten.top', // 网站地址
